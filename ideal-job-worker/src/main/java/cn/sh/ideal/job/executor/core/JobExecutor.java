...
public class JobExecutor {
  ...
  private final List<RemoteTaskExecutor> remoteExecutors = new ArrayList<>();
  ...
  public void destroy() {
    if (!destroyed) {
      ...
      destroyed = true;
      for (RemoteTaskExecutor remoteExecutor : remoteExecutors) {
...
//    List<RemoteJobExecutor> remoteExecutors = new ArrayList<>();
    ...
    LbServerHolder<RemoteTaskExecutor> holder = getServerHolder();
    holder.addServers(remoteExecutors, true);
  }

  public LbServerHolder<RemoteTaskExecutor> getServerHolder() {
