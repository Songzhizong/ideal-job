 ...
 * @date 2020/8/20
 */
public class SocketJobExecutor implements JobExecutor {
  private static final Logger log = LoggerFactory.getLogger(SocketJobExecutor.class);
  ...
  public SocketJobExecutor(@Nonnull String appName,
